  ...
  return (
    <div ref={ref} className={cn('ct-theme-switcher', className)}>
      ...
      >
        ...
        <svg className="ct-theme-switcher__chevron" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="6 9 12 15 18 9"/></svg>
      </button>
          ...
          {TERMINAL_THEMES.map((theme: TerminalThemeDef) => (
            ...
            >
              ...
              {theme.id === currentThemeId && (
                <svg className="ct-theme-switcher__check" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><polyline points="20 6 9 17 4 12"/></svg>
              )}
            </button>
          ))}
        </div>
