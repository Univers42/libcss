...
/* ─── Available animation names (from libcss) ───────── */
...
/** Speed modifiers */
export type AnimSpeed = 'lcss-anim--fast' | 'lcss-anim--normal' | 'lcss-anim--slow' | 'lcss-anim--slower';
...
export interface ElementAnimation {
  ...
  readonly delay?: 'lcss-anim--delay-1' | 'lcss-anim--delay-2' | 'lcss-anim--delay-3' | 'lcss-anim--delay-4';
}
...
export const ANIM_PRESET_SMOOTH: AnimationPreset = {
  ...
  statusBar: { className: 'lcss-anim-slide-up', speed: 'lcss-anim--fast', delay: 'lcss-anim--delay-2' },
};
...
export const ANIM_PRESET_BOUNCY: AnimationPreset = {
  ...
  header: { className: 'lcss-anim-bounce-in', speed: 'lcss-anim--fast', delay: 'lcss-anim--delay-1' },
...
export const ANIM_PRESET_ELEGANT: AnimationPreset = {
  ...
  statusBar: { className: 'lcss-anim-slide-up', speed: 'lcss-anim--slow', delay: 'lcss-anim--delay-3' },
};
