  ...
  return (
    <div ref={ref} className={cn('ct-anim-switcher', className)}>
      ...
      >
        ...
        <svg className="ct-anim-switcher__chevron" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="6 9 12 15 18 9"/></svg>
      </button>
          ...
          {BG_EFFECTS.map((effect: BackgroundEffect) => (
            ...
            >
              ...
              {effect.id === currentEffectId && (
                <svg className="ct-anim-switcher__check" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><polyline points="20 6 9 17 4 12"/></svg>
              )}
            </button>
          ))}
        </div>
